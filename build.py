...
<link rel="alternate" type="application/rss+xml" title="{BRAND} 안내 업데이트" href="{BASE_URL.rstrip('/')}/rss.xml">
...
<header class="site-header">
  ...
  <div class="header-top">
    <div class="header-inner">
      ...
      <p class="header-tagline"><span class="tag-gem">◆</span> 구리시 전지역 방문 관리 <span class="tag-gem">◆</span> 24시간 상담</p>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">경기도 구리시 전지역 방문 출장마사지·홈타이 안내 사이트입니다. 모든 서비스는 안내된 관리 범위와 위생·안전 기준 안에서만 제공됩니다.</p>
      <address class="footer-contact">
        ...
        <span class="footer-contact-row"><span class="footer-label">서비스 지역</span> 경기도 구리시 전지역</span>
      </address>
    </div>
    <nav class="footer-col" aria-label="서비스 안내">
      <p class="footer-title">서비스</p>
      <ul>
        <li><a href="/">구리 출장마사지</a></li>
...
def build() -> None:
    report = []
    indexed = []  # (url, title, desc) — sitemap/RSS 대상
    base = BASE_URL.rstrip("/")
    now = datetime.now(timezone.utc)
    today = now.strftime("%Y-%m-%d")

    for page in PAGES:
        path = page["path"]  # "" 또는 "guri/galmae-dong-chuljangmassage/" 형태
    ...
    # rss.xml (네이버·빙 등 피드 수집 + 업데이트 발견 가속)
    ...
    with open(os.path.join(ROOT, "rss.xml"), "w", encoding="utf-8") as f:
        f.write(
            ...
            "  <channel>\n"
            f"    <title>{esc(BRAND)} — 구리 출장마사지·홈타이 안내</title>\n"
            f"    <link>{base}/</link>\n"
            f"    <atom:link href=\"{base}/rss.xml\" rel=\"self\" type=\"application/rss+xml\"/>\n"
            "    <description>경기도 구리시 방문 관리(출장마사지·홈타이) 안내 업데이트</description>\n"
